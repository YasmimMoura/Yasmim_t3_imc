...
function displayResultImage(classification) {
    ...
    switch (classification) {
        case 'Baixo peso':
            imagePath = '../img/pessoa1.png'; // Corrigido o caminho da imagem
            break;
        case 'Normal':
            imagePath = '../img/pessoa2.png'; // Corrigido o caminho da imagem
            break;
        case 'Sobrepeso':
            imagePath = '../img/pessoa2.png'; // Corrigido o caminho da imagem
            break;
        case 'Obesidade I':
            imagePath = '../img/pessoa4.png'; // Corrigido o caminho da imagem
            break;
        case 'Obesidade II':
        case 'Obesidade III':
            imagePath = '../img/pessoa5.png'; // Corrigido o caminho da imagem
            break;
        default:
            imagePath = '../img/pessoas.png'; // Corrigido o caminho da imagem
    }
